...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[IndexOptimizeOlaOneTime]') AND type in (N'P', N'PC'))
BEGIN
EXEC dbo.sp_executesql @statement = N'CREATE PROCEDURE [dbo].[IndexOptimizeOlaOneTime] AS'
END
GO
ALTER PROCEDURE [dbo].[IndexOptimizeOlaOneTime]

SELECT ' CREATE ' + CASE
    ...
    END + ' ) ON [' + DS.name + ' ] ' + CHAR(13) + CHAR(10) + ' GO' [CreateIndexScript]
FROM sys.indexes I
    ...
    JOIN (
        ...
        FROM (
                ...
                FROM sys.index_columns IC2 --WHERE IC2.Object_id = object_id('Person.Address') --Comment for all tables
...
WHERE I.is_primary_key = 0
    AND I.is_unique_constraint = 0 --AND I.Object_id = object_id('Person.Address') --Comment for all tables
